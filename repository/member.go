...
func NewMemberRepo(db *gorm.DB) models.IMemberRepo {
	return &MemberRepo{
		DB: db,
	}
}

func (mr *MemberRepo) GetAll(ctx *gin.Context) ([]models.Member, error) {
...
func (mr *MemberRepo) CreateMember(payload *models.CreateMemberRequest, ctx *gin.Context) (models.Member, error) {
	roles := []*models.Role{}
...
func (mr *MemberRepo) UpdateMember(id int, payload *models.CreateMemberRequest, ctx *gin.Context) (models.Member, error) {
	member := models.Member{
		Name:      payload.Name,
		Email:     payload.Email,
		TeamID:    int(payload.TeamID),
...
func (mr *MemberRepo) GetMemberById(id int) (models.Member, error) {
	member := models.Member{}
	result := mr.DB.Where("id = ?", id).Preload("Roles").Preload("Projects").Preload("Team").First(&member, id)
	return member, result.Error
}

func (mr *MemberRepo) DeleteMember(id int) error {
	result := mr.DB.Delete(&models.Member{}, id).Error
	return result
}

func (mr *MemberRepo) AssignProjectsToMember(memberId int, projectIds []int) error {
	member := models.Member{}
	projects := []models.Project{}
...
func (mr *MemberRepo) AssignRolesToMember(memberId int, roleIds []int) error {
	member := models.Member{}
	roles := []models.Role{}
